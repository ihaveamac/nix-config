...
# shared across NixOS, nix-darwin, and Home Manager
{
  ...
  nix.registry = {
    jovian = {
      from = { id = "jovian"; type = "indirect"; };
      to = { owner = "Jovian-Experiments"; repo = "Jovian-NixOS"; type = "github"; };
    };
    nixos-apple-silicon = {
      from = { id = "nixos-apple-silicon"; type = "indirect"; };
      to = { owner = "tpwrules"; repo = "nixos-apple-silicon"; type = "github"; };
    };
    hax-nur = {
      from = { id = "hax-nur"; type = "indirect"; };
      to = { owner = "ihaveamac"; repo = "nur-packages"; type = "github"; };
    };
  };
  nix.settings = {
    ...
    extra-nix-path = [ "nixpkgs=flake:nixpkgs" "nur=flake:nur" "hax-nur=flake:hax-nur" ];
