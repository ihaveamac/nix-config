{ lib, ... }: {
  ...
  networking = {
    ...
    interfaces = {
      eth0 = {
        ipv4.addresses = [
          { address="104.236.76.172"; prefixLength=18; }
{ address="10.17.0.5"; prefixLength=16; }
        ];
        ipv6.addresses = [
          { address="2604:a880:800:10::640:a001"; prefixLength=64; }
{ address="fe80::686f:b6ff:fea5:ab2"; prefixLength=64; }
        ];
        ipv4.routes = [ { address = "104.236.64.1"; prefixLength = 32; } ];
        ...
        ipv6.addresses = [
          { address="fe80::b4b7:f7ff:fe65:5731"; prefixLength=64; }
        ];
        };
    };
  };
